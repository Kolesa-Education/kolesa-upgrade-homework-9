...
$app->get('/adverts/{args}', Controllers\LabelController::class . ':labelid');
$app->get('/adverts/{args}/edit', Controllers\LabelController::class . ':edit');
$app->post('/adverts/{args}/edit', Controllers\LabelController::class . ':edit');
